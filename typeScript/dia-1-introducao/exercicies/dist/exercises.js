...
exports.getTrapezioArea = exports.getLosanguloArea = exports.triangleCheck = exports.getPolygonPerimeter = exports.getTriangleArea = exports.getRectangleArea = exports.getSquareArea = void 0;
...
;
function getLosanguloArea(Dmaior, Dmenor) {
    return (Dmaior * Dmenor) / 2;
}
exports.getLosanguloArea = getLosanguloArea;
function getTrapezioArea(Bmaior, bmenor, height) {
