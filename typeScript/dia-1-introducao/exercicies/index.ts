...
console.log(`Calcule a área de um losango que tem D = 32cm e d = 18cm; ${Ex.getLosanguloArea(32, 18)} `)

console.log(`Calcule a área de um trapézio que tem B = 100cm, b = 70cm e altura = 50cm;${Ex.getTrapezioArea(100, 70, 50)}`)
